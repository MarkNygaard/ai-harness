---
title: "Linear epics"
description: "Delegate an issue with sub-issues: how each is built in turn on a shared branch, the columns the relay needs, and what stalls it."
---
...
[Authoring workflows](/docs/workflows/authoring); for connecting a Linear
account see [Connecting Linear](/docs/triggers/linear-connect).
